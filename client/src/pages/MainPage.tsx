...
function MainPage() {
  ...
  return (
    <>
      <YearSelect
        controlYearSelect={controlYearSelect}
        ...
        <>
          <div className={styles.frame}>
            <div
              ...
              id={detailVisible === true ? styles.moveUpward : undefined}
            >
              <section>
                <h2>
                  제<span>{year}</span>대 대통령 선거
                </h2>
              </section>
              <div
